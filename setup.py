...
setup(name='docassemble.JacksALGenericJurisdiction',
      version='0.0.3',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/JacksALGenericJurisdiction/', package='docassemble.JacksALGenericJurisdiction'),
     )
